...
import { useGetRandomPeople } from "@hooks/api";
...
export default function Homepage() {
  const randomPeople = useGetRandomPeople<RandomPeople>();
            ...
            <div className="mt-10 max-w-sm mx-auto sm:max-w-none sm:flex sm:justify-center">
              <div className="space-y-4 sm:space-y-0 sm:mx-auto sm:inline-grid sm:grid-cols-3 sm:gap-5">
                ...
                <Button variant="outline" size="lg" className="w-full" asChild>
                  <Link to="some-non-existing-location">404</Link>
                </Button>
              </div>
            </div>
          </div>
      ...
      <section className="mx-auto py-16 px-4 sm:px-6 lg:px-8 bg-primary text-primary-foreground">
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {randomPeople.isSuccess &&
            randomPeople.data.data.map((person) => (
              <Card key={person.firstname}>
                <CardHeader>
                  <CardTitle>
        ...
        <div className="bg-accent shadow-lg rounded-lg overflow-hidden">
          <div className="px-6 py-8">
            ...
            <p className="italic font-semibold">
              "This SaaS solution has transformed our business operations. We've
